...
C:/mingw64/bin/gcc libs/bm256.o libs/x25519.o libs/converters.o libs/gerio.o libs/httpc.o libs/tlsbase.o libs/basics.o libs/p256.o libs/sha.o libs/prf.o libs/aes.o libs/cbc.o libs/gcm.o main.o libs/ber_entity.o -o main.exe -lws2_32